...
import { COPY_fail, COPY_SUCCES } from "./messaje";
...
function App() {
  ...
  const handleGeneratePassword = () => {
    if (
      ...
      notify("To generate password you must select one checkbox", true);
    } else {
      let characterList = "";
      if (includeNumbers) {
    ...
    <div className="App">
      <div className="container">
        <div className="generator">
          ...
          <div className="form-group">
            <label htmlFor="uppercase-letters">Add Uppercase Letter</label>
            <input
